...
namespace ECommerce_Blazor.Server.Migrations
{
    ...
    [Migration("20230314183422_ForImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.CartItem", b =>
                {
                    ...
                    b.HasKey("UserId", "Id", "ProductTypeId");

                    b.ToTable("CartItems");
                });

            modelBuilder.Entity("ECommerce_Blazor.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.Image", b =>
                {
                    b.HasOne("ECommerce_Blazor.Shared.Product", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.OrderItem", b =>
                {
                    ...
                    b.HasOne("ECommerce_Blazor.Shared.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce_Blazor.Shared.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerce_Blazor.Shared.Product", b =>
                {
                    b.HasOne("ECommerce_Blazor.Shared.Category", "Category")
                        .WithMany()
